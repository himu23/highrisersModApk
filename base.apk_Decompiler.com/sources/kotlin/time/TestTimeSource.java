...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1611plusAssignLRDsOJo(long j) {
        long j2;
        long r0 = Duration.m1522toLongimpl(j, getUnit());
        if (r0 == Long.MIN_VALUE || r0 == Long.MAX_VALUE) {
            double r2 = ((double) this.reading) + Duration.m1519toDoubleimpl(j, getUnit());
    ...
    private final void m1610overflowLRDsOJo(long j) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + DurationUnitKt.shortName(getUnit()) + " is advanced by " + Duration.m1525toStringimpl(j) + '.');
    }
}
