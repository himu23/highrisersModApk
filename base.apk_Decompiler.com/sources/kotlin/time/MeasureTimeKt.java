...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> function0) {
        ...
        function0.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1622elapsedNowUwyO8pc(r0);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(function0, "block");
        return new TimedValue<>(function0.invoke(), TimeSource.Monotonic.ValueTimeMark.m1622elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m1617markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource.Monotonic monotonic, Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(monotonic, "<this>");
        Intrinsics.checkNotNullParameter(function0, "block");
        return new TimedValue<>(function0.invoke(), TimeSource.Monotonic.ValueTimeMark.m1622elapsedNowUwyO8pc(monotonic.m1617markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
}
