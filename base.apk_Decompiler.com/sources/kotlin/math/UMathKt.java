...
public final class UMathKt {
    ...
    private static final int m1364minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1346minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI  reason: not valid java name */
    private static final long m1365mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1354minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU  reason: not valid java name */
    private static final int m1362maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1334maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI  reason: not valid java name */
    private static final long m1363maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1342maxOfeb3DHEI(j, j2);
    }
}
