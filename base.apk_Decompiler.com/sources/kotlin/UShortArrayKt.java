...
public final class UShortArrayKt {
    ...
    private static final short[] m494ushortArrayOfrL5Bavg(short... sArr) {
    ...
    private static final short[] UShortArray(int i, Function1<? super Integer, UShort> function1) {
        Intrinsics.checkNotNullParameter(function1, m2.a.e);
        short[] sArr = new short[i];
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = function1.invoke(Integer.valueOf(i2)).m475unboximpl();
        }
        return UShortArray.m478constructorimpl(sArr);
    }
}
