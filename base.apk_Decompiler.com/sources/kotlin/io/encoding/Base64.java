    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        ...
        while (i5 + 2 < i6) {
            ...
            for (int i9 = 0; i9 < min; i9++) {
                ...
                i5 += 3;
                byte b3 = (b2 << 8) | (b << Ascii.DLE) | (bArr3[i10] & UByte.MAX_VALUE);
                bArr4[i8] = access$getBase64UrlEncodeMap$p[b3 >>> Ascii.DC2];
                bArr4[i8 + 1] = access$getBase64UrlEncodeMap$p[(b3 >>> Ascii.FF) & 63];
                int i11 = i8 + 3;
