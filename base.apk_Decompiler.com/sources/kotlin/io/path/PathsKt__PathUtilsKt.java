...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    private static final String absolutePathString(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        return PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$3(path).toString();
    }
    ...
    private static final boolean isSameFileAs(Path path, Path path2) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(path2, InneractiveMediationNameConsts.OTHER);
    ...
    static /* synthetic */ java.lang.Object useDirectoryEntries$default(java.nio.file.Path r0, java.lang.String r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            java.nio.file.DirectoryStream r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r0)     // Catch:{ all -> 0x0039 }
    ...
    private static final <T> T useDirectoryEntries(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<? extends java.nio.file.Path>, ? extends T> r4) throws java.io.IOException {
        /*
            ...
            java.nio.file.DirectoryStream r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r2, (java.lang.String) r3)
            java.io.Closeable r2 = (java.io.Closeable) r2
            r3 = 1
            java.nio.file.DirectoryStream r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0034 }
    ...
    static /* synthetic */ void forEachDirectoryEntry$default(java.nio.file.Path r0, java.lang.String r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            java.nio.file.DirectoryStream r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r0, (java.lang.String) r1)
            java.io.Closeable r0 = (java.io.Closeable) r0
            java.nio.file.DirectoryStream r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r0)     // Catch:{ all -> 0x0045 }
            java.lang.String r3 = "it"
    ...
    private static final void forEachDirectoryEntry(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1<? super java.nio.file.Path, kotlin.Unit> r4) throws java.io.IOException {
        /*
            ...
            java.io.Closeable r2 = (java.io.Closeable) r2
            r3 = 1
            java.nio.file.DirectoryStream r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0040 }
            java.lang.String r1 = "it"
    ...
    private static final Path moveTo(Path path, Path path2, CopyOption... copyOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(m$1, "move(this, target, *options)");
        return m$1;
    }
    ...
    private static final FileStore fileStore(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        FileStore m = StreamsKt$$ExternalSyntheticApiModelOutline0.m(path);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... linkOptionArr) {
        ...
        Class m$2 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$2();
        Class cls = m$2;
        return PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, m$2, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... linkOptionArr) {
        ...
        Class m$2 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$2();
        Class cls = m$2;
        FileAttributeView m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, m$2, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
        if (m != null) {
            return PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Object) m);
        }
        Intrinsics.reifiedOperationMarker(4, "V");
        Class m$22 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$2();
        Class cls2 = m$22;
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... linkOptionArr) throws IOException {
        ...
        Class cls = m;
        BasicFileAttributes m2 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, m, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    ...
    private static final Map<String, Object> readAttributes(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        Map<String, Object> m = Files.readAttributes(path, str, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    ...
    private static final Path setLastModifiedTime(Path path, FileTime fileTime) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(fileTime, m2.h.X);
    ...
    private static final Path setOwner(Path path, UserPrincipal userPrincipal) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(userPrincipal, m2.h.X);
    ...
    private static final Path setPosixFilePermissions(Path path, Set<? extends PosixFilePermission> set) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(set, m2.h.X);
    ...
    private static final Path div(Path path, String str) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(str, InneractiveMediationNameConsts.OTHER);
