...
final class DefaultCopyActionContext implements CopyActionContext {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0038, code lost:
        if (kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r6, (java.nio.file.LinkOption[]) java.util.Arrays.copyOf(new java.nio.file.LinkOption[]{kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()}, 1)) == false) goto L_0x003a;
     */
    ...
    public kotlin.io.path.CopyActionResult copyToIgnoringExistingDirectory(java.nio.file.Path r5, java.nio.file.Path r6, boolean r7) {
        /*
            ...
            java.nio.file.LinkOption[] r0 = (java.nio.file.LinkOption[]) r0
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r5, (java.nio.file.LinkOption[]) r0)
            if (r0 == 0) goto L_0x003a
            r0 = 1
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            r2 = 0
            java.nio.file.LinkOption r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()
            r1[r2] = r3
            java.lang.Object[] r0 = java.util.Arrays.copyOf(r1, r0)
            java.nio.file.LinkOption[] r0 = (java.nio.file.LinkOption[]) r0
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r6, (java.nio.file.LinkOption[]) r0)
