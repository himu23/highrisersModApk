...
final class PathsKt__PathRecursiveFunctionsKt$copyToRecursively$2 extends Lambda implements Function3<CopyActionContext, Path, Path, CopyActionResult> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
        return invoke((CopyActionContext) obj, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(obj2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(obj3));
    }
    ...
    public final CopyActionResult invoke(CopyActionContext copyActionContext, Path path, Path path2) {
        ...
        boolean m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2, (LinkOption[]) Arrays.copyOf(new LinkOption[]{PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()}, 1));
        LinkOption[] linkOptionArr = (LinkOption[]) Arrays.copyOf(linkOptions, linkOptions.length);
        if (!PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length)) || !m) {
            if (m) {
                PathsKt.deleteRecursively(path2);
            }
            SpreadBuilder spreadBuilder = new SpreadBuilder(2);
            spreadBuilder.addSpread(linkOptions);
            spreadBuilder.add(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m());
