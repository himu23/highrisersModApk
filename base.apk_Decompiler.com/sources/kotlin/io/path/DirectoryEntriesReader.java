...
final class DirectoryEntriesReader extends SimpleFileVisitor<Path> {
    ...
    public final List<PathNode> readEntries(PathNode pathNode) {
        ...
        Path unused = Files.walkFileTree(pathNode.getPath(), LinkFollowing.INSTANCE.toVisitOptions(this.followLinks), 1, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Object) this));
    ...
    public FileVisitResult preVisitDirectory(Path path, BasicFileAttributes basicFileAttributes) {
        ...
        this.entries.add(new PathNode(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(basicFileAttributes), this.directoryNode));
    ...
    public FileVisitResult visitFile(Path path, BasicFileAttributes basicFileAttributes) {
        Intrinsics.checkNotNullParameter(path, m2.h.b);
        Intrinsics.checkNotNullParameter(basicFileAttributes, "attrs");
