...
final class PathRelativizer {
    ...
    public final Path tryRelativeTo(Path path, Path path2) {
        ...
        Path m$2 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$2(path2);
        Path m$22 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$2(path);
        Path m$1 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(m$2, m$22);
        ...
        Intrinsics.checkNotNullExpressionValue(m$22, AndroidDynamicDeviceInfoDataSource.DIRECTORY_MODE_READ);
        return m$22;
    }
}
