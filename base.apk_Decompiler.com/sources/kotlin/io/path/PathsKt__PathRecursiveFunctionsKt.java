...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(Path path, Path path2, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function3, boolean z, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function32) {
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path))) {
                boolean z2 = Files.exists(path2, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2);
                if ((!z2 || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, path2)) && Intrinsics.areEqual((Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path), (Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2)) && (!z2 ? !((m$1 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path2)) == null || !Files.exists(m$1, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(m$1, new LinkOption[0]), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, new LinkOption[0]))) : PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2, new LinkOption[0]), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, new LinkOption[0])))) {
                    PathTreeWalk$$ExternalSyntheticApiModelOutline0.m();
                    throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path.toString(), path2.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
                }
            }
        ...
        throw PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path.toString(), path2.toString(), "The source file doesn't exist.");
    }
    ...
    private static final Path copyToRecursively$destination$PathsKt__PathRecursiveFunctionsKt(Path path, Path path2, Path path3) {
        Path m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2, PathsKt.relativeTo(path3, path).toString());
        Intrinsics.checkNotNullExpressionValue(m, "target.resolve(relativePath.pathString)");
        return m;
    }
    ...
    public static final void deleteRecursively(Path path) {
        ...
        if (!deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.isEmpty()) {
            ...
            for (Exception addSuppressed : deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt) {
                ExceptionsKt.addSuppressed(m, addSuppressed);
            }
            throw m;
        }
    }
    ...
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        /*
            ...
            r3 = 0
            r0.<init>(r1, r2, r3)
            java.nio.file.Path r4 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1((java.nio.file.Path) r8)
            if (r4 == 0) goto L_0x0047
            java.nio.file.DirectoryStream r5 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r4)     // Catch:{ all -> 0x0013 }
            goto L_0x0015
        L_0x0013:
            r5 = r3
        L_0x0015:
            ...
            java.nio.file.DirectoryStream r6 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r5)     // Catch:{ all -> 0x0040 }
            boolean r7 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x0040 }
            if (r7 == 0) goto L_0x0037
            r0.setPath(r4)     // Catch:{ all -> 0x0040 }
            java.nio.file.SecureDirectoryStream r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x0040 }
            java.nio.file.Path r4 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r8)     // Catch:{ all -> 0x0040 }
    ...
    private static final void handleEntry$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            if (isDirectory$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStream, path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m())) {
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.SecureDirectoryStream<java.nio.file.Path> r4, java.nio.file.Path r5, kotlin.io.path.ExceptionsCollector r6) {
        /*
            ...
            java.nio.file.LinkOption r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()     // Catch:{ NoSuchFileException -> 0x0012 }
            r3 = 0
        ...
        L_0x0014:
            ...
            java.nio.file.SecureDirectoryStream r5 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r4)     // Catch:{ all -> 0x0041 }
        ...
        L_0x0020:
            ...
            java.nio.file.Path r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0041 }
            java.nio.file.Path r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r2)     // Catch:{ all -> 0x0041 }
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean bool;
        try {
            bool = Boolean.valueOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Object) secureDirectoryStream.getFileAttributeView(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes()));
        } catch (NoSuchFileException unused) {
            bool = null;
        }
        if (bool != null) {
    ...
    private static final void insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        try {
            if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, (LinkOption[]) Arrays.copyOf(new LinkOption[]{PathTreeWalk$$ExternalSyntheticApiModelOutline0.m()}, 1))) {
                int totalExceptions = exceptionsCollector.getTotalExceptions();
                insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(path, exceptionsCollector);
                if (totalExceptions == exceptionsCollector.getTotalExceptions()) {
                    PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path);
                    return;
                }
                return;
            }
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r4, kotlin.io.path.ExceptionsCollector r5) {
        /*
            r0 = 0
            java.nio.file.DirectoryStream r4 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r4)     // Catch:{ NoSuchFileException -> 0x0008 }
            goto L_0x000a
        L_0x0006:
            r4 = move-exception
            goto L_0x003a
        ...
        L_0x000a:
            ...
            java.nio.file.DirectoryStream r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r4)     // Catch:{ all -> 0x0033 }
        ...
        L_0x0016:
            ...
            java.nio.file.Path r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0033 }
            java.lang.String r3 = "entry"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x0033 }
            insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(r2, r5)     // Catch:{ all -> 0x0033 }
            goto L_0x0016
        L_0x002d:
