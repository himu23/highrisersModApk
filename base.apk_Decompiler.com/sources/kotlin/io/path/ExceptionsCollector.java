...
final class ExceptionsCollector {
    ...
    public final void enterEntry(Path path2) {
        ...
        this.path = path3 != null ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path3, path2) : null;
    }
    ...
    public final void exitEntry(Path path2) {
        ...
        Path path3 = this.path;
        Path path4 = null;
        if (Intrinsics.areEqual((Object) path2, (Object) path3 != null ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path3) : null)) {
            Path path5 = this.path;
            if (path5 != null) {
                path4 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path5);
            }
            this.path = path4;
            return;
        }
    ...
    public final void collect(Exception exc) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                ...
                Throwable m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(String.valueOf(this.path)).initCause(exc);
                Intrinsics.checkNotNull(m, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exc = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Object) m);
            }
