...
class ComparisonsKt___ComparisonsJvmKt extends ComparisonsKt__ComparisonsKt {
    ...
    public static final <T extends Comparable<? super T>> T maxOf(T t, T... tArr) {
        Intrinsics.checkNotNullParameter(t, "a");
        Intrinsics.checkNotNullParameter(tArr, InneractiveMediationNameConsts.OTHER);
        for (T maxOf : tArr) {
    ...
    public static final float maxOf(float f, float... fArr) {
        Intrinsics.checkNotNullParameter(fArr, InneractiveMediationNameConsts.OTHER);
        for (float max : fArr) {
            f = Math.max(f, max);
        }
        return f;
    ...
    public static final double maxOf(double d, double... dArr) {
        Intrinsics.checkNotNullParameter(dArr, InneractiveMediationNameConsts.OTHER);
        for (double max : dArr) {
            d = Math.max(d, max);
        }
        return d;
