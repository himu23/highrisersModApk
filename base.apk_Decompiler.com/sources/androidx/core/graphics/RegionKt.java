...
public final class RegionKt {
    ...
    public static final Region plus(Region region, Rect rect) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(rect, AndroidDynamicDeviceInfoDataSource.DIRECTORY_MODE_READ);
    ...
    public static final Region plus(Region region, Region region2) {
        Intrinsics.checkNotNullParameter(region, "<this>");
        Intrinsics.checkNotNullParameter(region2, AndroidDynamicDeviceInfoDataSource.DIRECTORY_MODE_READ);
