...
public final class RectKt {
    ...
    public static final Rect plus(Rect rect, Rect rect2) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        Intrinsics.checkNotNullParameter(rect2, AndroidDynamicDeviceInfoDataSource.DIRECTORY_MODE_READ);
    ...
    public static final RectF plus(RectF rectF, RectF rectF2) {
        Intrinsics.checkNotNullParameter(rectF, "<this>");
        Intrinsics.checkNotNullParameter(rectF2, AndroidDynamicDeviceInfoDataSource.DIRECTORY_MODE_READ);
