...
public final class WindowInsetsAnimationControllerCompat {
    ...
    private static class Impl30 extends Impl {
        ...
        public Insets getHiddenStateInsets() {
            return Insets.toCompatInsets(HalfKt$$ExternalSyntheticApiModelOutline0.m$1(this.mController));
        }
        ...
        public Insets getCurrentInsets() {
            return Insets.toCompatInsets(HalfKt$$ExternalSyntheticApiModelOutline0.m(this.mController));
        }
