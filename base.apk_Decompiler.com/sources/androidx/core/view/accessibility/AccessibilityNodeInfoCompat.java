...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                accessibilityAction = Trace$$ExternalSyntheticApiModelOutline0.m();
            } else {
    ...
    public boolean isImportantForAccessibility() {
        if (Build.VERSION.SDK_INT >= 24) {
            return Trace$$ExternalSyntheticApiModelOutline0.m(this.mInfo);
        }
        return true;
    }
    ...
    public CharSequence getStateDescription() {
        if (BuildCompat.isAtLeastR()) {
            return Trace$$ExternalSyntheticApiModelOutline0.m$3(this.mInfo);
        }
    ...
    public AccessibilityNodeInfoCompat getTraversalBefore() {
        if (Build.VERSION.SDK_INT >= 22) {
            return wrapNonNullInstance(Trace$$ExternalSyntheticApiModelOutline0.m$1(this.mInfo));
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat getTraversalAfter() {
        if (Build.VERSION.SDK_INT >= 22) {
            return wrapNonNullInstance(Trace$$ExternalSyntheticApiModelOutline0.m(this.mInfo));
        }
        return null;
    }
    ...
    public CharSequence getTooltipText() {
        if (Build.VERSION.SDK_INT >= 28) {
            return Trace$$ExternalSyntheticApiModelOutline0.m$1(this.mInfo);
        }
    ...
    public CharSequence getPaneTitle() {
        if (Build.VERSION.SDK_INT >= 28) {
            return Trace$$ExternalSyntheticApiModelOutline0.m$2(this.mInfo);
        }
    ...
    public TouchDelegateInfoCompat getTouchDelegateInfo() {
        ...
        if (Build.VERSION.SDK_INT < 29 || (m = Trace$$ExternalSyntheticApiModelOutline0.m(this.mInfo)) == null) {
            return null;
        }
