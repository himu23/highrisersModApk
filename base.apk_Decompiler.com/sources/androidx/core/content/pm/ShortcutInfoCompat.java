...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        NotificationCompat$$ExternalSyntheticApiModelOutline8.m$4();
        ShortcutInfo.Builder m = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo m : list) {
            arrayList.add(new Builder(context, NotificationCompat$$ExternalSyntheticApiModelOutline8.m((Object) m)).build());
        }
        return arrayList;
    }
    ...
    static LocusIdCompat getLocusId(ShortcutInfo shortcutInfo) {
        if (Build.VERSION.SDK_INT < 29) {
            return getLocusIdFromExtra(NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo));
        }
        if (NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo) == null) {
            return null;
        }
        return LocusIdCompat.toLocusIdCompat(NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo));
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, ShortcutInfo shortcutInfo) {
            ...
            this.mInfo = shortcutInfoCompat;
            shortcutInfoCompat.mContext = context;
            shortcutInfoCompat.mId = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
            shortcutInfoCompat.mPackageName = NotificationCompat$$ExternalSyntheticApiModelOutline8.m$1(shortcutInfo);
            Intent[] m = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(m, m.length);
            shortcutInfoCompat.mActivity = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLabel = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            ...
            shortcutInfoCompat.mCategories = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
            shortcutInfoCompat.mPersons = ShortcutInfoCompat.getPersonsFromExtra(NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo));
            shortcutInfoCompat.mUser = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
            shortcutInfoCompat.mLastChangedTimestamp = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 30) {
                shortcutInfoCompat.mIsCached = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
            }
            shortcutInfoCompat.mIsDynamic = NotificationCompat$$ExternalSyntheticApiModelOutline8.m$1(shortcutInfo);
            ...
            shortcutInfoCompat.mRank = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
            shortcutInfoCompat.mExtras = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(shortcutInfo);
        }
