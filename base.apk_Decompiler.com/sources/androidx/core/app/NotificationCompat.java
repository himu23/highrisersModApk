...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                this.mSmallIcon = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(notification);
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline8.m().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(NotificationCompat$$ExternalSyntheticApiModelOutline8.m$1().getName())) {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && NotificationCompat$$ExternalSyntheticApiModelOutline8.m((Object) parcelable)) {
                return IconCompat.createFromIcon(NotificationCompat$$ExternalSyntheticApiModelOutline8.m((Object) parcelable));
            }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (Build.VERSION.SDK_INT >= 28) {
                    NotificationCompat$$ExternalSyntheticApiModelOutline8.m();
                    messagingStyle = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(this.mUser.toAndroidPerson());
                } else {
                    NotificationCompat$$ExternalSyntheticApiModelOutline8.m();
                    messagingStyle = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(this.mUser.getName());
                }
        ...
        public static final class Message {
            ...
            public android.app.Notification.MessagingStyle.Message toAndroidMessage() {
                /*
                    ...
                    androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline8.m$1()
                ...
                L_0x001d:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline8.m((java.lang.CharSequence) r1, (long) r4, (android.app.Person) r3)
                    goto L_0x0038
                L_0x0022:
                    androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline8.m$1()
                    java.lang.CharSequence r1 = r6.getText()
                ...
                L_0x0034:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat$$ExternalSyntheticApiModelOutline8.m((java.lang.CharSequence) r1, (long) r4, (java.lang.CharSequence) r3)
                L_0x0038:
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 24) {
                notificationBuilderWithBuilderAccessor.getBuilder().setStyle(NotificationCompat$$ExternalSyntheticApiModelOutline8.m());
            }
        }
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public static Builder fromAndroidAction(Notification.Action action) {
                Builder builder;
                if (Build.VERSION.SDK_INT < 23 || ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action) == null) {
                    builder = new Builder(action.icon, action.title, action.actionIntent);
                } else {
                    builder = new Builder(IconCompat.createFromIcon(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action)), action.title, action.actionIntent);
                }
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                IconCompat iconCompat = action.getIconCompat();
                NotificationCompat$$ExternalSyntheticApiModelOutline8.m$2();
                if (iconCompat == null) {
                    icon = null;
                } else {
                    icon = iconCompat.toIcon();
                }
                builder = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(icon, action.getTitle(), action.getActionIntent());
            } else {
    ...
    public static BubbleMetadata getBubbleMetadata(Notification notification) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BubbleMetadata.fromPlatform(NotificationCompat$$ExternalSyntheticApiModelOutline8.m(notification));
        }
        return null;
    }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        boolean m$2 = Build.VERSION.SDK_INT >= 31 ? action.isAuthenticationRequired() : false;
        if (Build.VERSION.SDK_INT < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, m$1, m$2);
        }
        if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action) == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, m$1, m$2);
        }
        if (ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(action));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, m$1, m$2);
    }
    ...
    public static String getShortcutId(Notification notification) {
        if (Build.VERSION.SDK_INT >= 26) {
            return NotificationCompat$$ExternalSyntheticApiModelOutline8.m(notification);
        }
        return null;
    }
