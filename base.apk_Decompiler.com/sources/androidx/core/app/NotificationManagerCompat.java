...
public final class NotificationManagerCompat {
    ...
    public boolean areNotificationsEnabled() {
        if (Build.VERSION.SDK_INT >= 24) {
            return NotificationCompat$$ExternalSyntheticApiModelOutline8.m(this.mNotificationManager);
        }
    ...
    public void deleteNotificationChannel(String str) {
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationCompat$$ExternalSyntheticApiModelOutline8.m(this.mNotificationManager, str);
        }
    }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            for (Object m : this.mNotificationManager.getNotificationChannels()) {
                ...
                if (!collection.contains(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1(m2)))) {
                    NotificationCompat$$ExternalSyntheticApiModelOutline8.m(this.mNotificationManager, ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2));
                }
            }
        }
    }
    ...
    public NotificationChannel getNotificationChannel(String str) {
        if (Build.VERSION.SDK_INT >= 26) {
            return NotificationCompat$$ExternalSyntheticApiModelOutline8.m(this.mNotificationManager, str);
        }
        return null;
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            for (NotificationChannelGroup m : getNotificationChannelGroups()) {
                NotificationChannelGroup m2 = NotificationCompat$$ExternalSyntheticApiModelOutline8.m((Object) m);
    ...
    private static class NotifyTask implements Task {
        ...
        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + m2.i.e;
        }
    }
    ...
    private static class CancelTask implements Task {
        ...
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.id + ", tag:" + this.tag + ", all:" + this.all + m2.i.e;
        }
    }
}
