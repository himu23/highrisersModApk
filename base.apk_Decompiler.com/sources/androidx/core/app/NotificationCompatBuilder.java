...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationCompat$$ExternalSyntheticApiModelOutline8.m$3();
            this.mBuilder = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(builder.mContext, builder.mChannelId);
        } else {
    ...
    private void addAction(NotificationCompat.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            builder = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(iconCompat != null ? iconCompat.toIcon() : null, action.getTitle(), action.getActionIntent());
        } else {
