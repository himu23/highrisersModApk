...
public class ViewModelProvider {
    ...
    public ViewModelProvider(ViewModelStore viewModelStore, Factory factory2) {
        ...
        Intrinsics.checkNotNullParameter(viewModelStore, m2.h.U);
    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        public AndroidViewModelFactory(Application application2) {
            this(application2, 0);
            Intrinsics.checkNotNullParameter(application2, m2.h.F);
        }
        ...
        public static final class Companion {
            ...
            public final AndroidViewModelFactory getInstance(Application application) {
                Intrinsics.checkNotNullParameter(application, m2.h.F);
