...
public class ApiHelperForM {
    ...
    public static WebMessage createWebMessage(WebMessageCompat webMessageCompat) {
        ay$$ExternalSyntheticApiModelOutline0.m();
    ...
    public static WebMessageCompat createWebMessageCompat(WebMessage webMessage) {
        return new WebMessageCompat(Trace$$ExternalSyntheticApiModelOutline0.m(webMessage), WebMessagePortImpl.portsToCompat(Trace$$ExternalSyntheticApiModelOutline0.m(webMessage)));
    }

    public static int getErrorCode(WebResourceError webResourceError) {
        return Trace$$ExternalSyntheticApiModelOutline0.m(webResourceError);
    }
