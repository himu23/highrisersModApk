...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() {
                ...
                public final void invoke(Throwable th) {
                    ...
                    do {
                        Object r0 = ChannelResult.m1674getOrNullimpl(this.messageQueue.m1689tryReceivePtdJZtk());
                        if (r0 == null) {
                            unit = null;
                            continue;
                        } else {
    ...
    public final void offer(T t) {
        Object r7 = this.messageQueue.m1691trySendJP2dKIU(t);
        if (r7 instanceof ChannelResult.Closed) {
            Throwable r72 = ChannelResult.m1673exceptionOrNullimpl(r7);
            if (r72 == null) {
                r72 = new ClosedSendChannelException("Channel was closed normally");
            }
            throw r72;
        } else if (!ChannelResult.m1679isSuccessimpl(r7)) {
