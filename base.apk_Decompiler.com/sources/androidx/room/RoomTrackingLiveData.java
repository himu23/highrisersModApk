    ...
    final Runnable mRefreshRunnable = new Runnable() {
        ...
        public void run() {
            ...
            L_0x001b:
                ...
                r3 = 0
            L_0x0027:
                androidx.room.RoomTrackingLiveData r4 = androidx.room.RoomTrackingLiveData.this     // Catch:{ all -> 0x005f }
                java.util.concurrent.atomic.AtomicBoolean r4 = r4.mInvalid     // Catch:{ all -> 0x005f }
                boolean r4 = r4.compareAndSet(r2, r1)     // Catch:{ all -> 0x005f }
            ...
            L_0x003b:
                r0 = move-exception
                java.lang.RuntimeException r2 = new java.lang.RuntimeException     // Catch:{ all -> 0x005f }
            ...
            L_0x0044:
                ...
                androidx.room.RoomTrackingLiveData r4 = androidx.room.RoomTrackingLiveData.this     // Catch:{ all -> 0x005f }
                r4.postValue(r0)     // Catch:{ all -> 0x005f }
            L_0x004b:
                androidx.room.RoomTrackingLiveData r0 = androidx.room.RoomTrackingLiveData.this
                java.util.concurrent.atomic.AtomicBoolean r0 = r0.mComputing
                r0.set(r1)
