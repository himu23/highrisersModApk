...
public class AdUnit {
        ...
        if (getAdUnitActivity() == null) {
            ...
            for (int i2 = 0; i2 < events.size(); i2++) {
                ...
                for (int i3 = 0; i3 < sparseArray2.size(); i3++) {
                    ...
                    try {
                        jSONObject4.put(m2.h.h, adUnitMotionEvent.getAction());
    ...
    public static void getSafeAreaInsets(WebViewCallback webViewCallback) {
        if (getAdUnitActivity() == null || getAdUnitActivity().getLayout() == null) {
            ...
            WindowInsets m = getAdUnitActivity().getLayout().getRootWindowInsets();
            if (m != null) {
                JSONObject jSONObject = new JSONObject();
                try {
                    Object invoke = m.getClass().getMethod("getDisplayCutout", new Class[0]).invoke(m, new Object[0]);
                    if (invoke != null) {
