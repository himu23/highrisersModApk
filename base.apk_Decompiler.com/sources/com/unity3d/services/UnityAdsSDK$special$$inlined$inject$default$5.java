...
public final class UnityAdsSDK$special$$inlined$inject$default$5 extends Lambda implements Function0<LegacyShowUseCase> {
    ...
    public final LegacyShowUseCase invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, Reflection.getOrCreateKotlinClass(LegacyShowUseCase.class));
    }
}
