...
public class DeviceInfoReaderPrivacyBuilder extends DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getPrivacyRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList(new String[]{"privacy", "gdpr", "unity", "pipl"}), Collections.singletonList(m2.h.X), Arrays.asList(new String[]{t4.R0, "exclude", "mode"}));
    }
}
