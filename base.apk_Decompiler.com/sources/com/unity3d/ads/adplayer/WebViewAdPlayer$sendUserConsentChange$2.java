...
final class WebViewAdPlayer$sendUserConsentChange$2 extends Lambda implements Function0<WebViewEvent> {
    final /* synthetic */ ByteString $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WebViewAdPlayer$sendUserConsentChange$2(ByteString byteString) {
        super(0);
