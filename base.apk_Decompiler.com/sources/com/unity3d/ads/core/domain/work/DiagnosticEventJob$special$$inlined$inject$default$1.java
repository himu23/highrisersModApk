...
public final class DiagnosticEventJob$special$$inlined$inject$default$1 extends Lambda implements Function0<GetRequestPolicy> {
    ...
    public final GetRequestPolicy invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, Reflection.getOrCreateKotlinClass(GetRequestPolicy.class));
    }
}
