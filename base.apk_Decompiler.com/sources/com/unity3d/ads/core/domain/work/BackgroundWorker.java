...
public final class BackgroundWorker {
    ...
    public final /* synthetic */ <T extends UniversalRequestJob> void invoke(UniversalRequestWorkerData universalRequestWorkerData) {
        ...
        Class cls2 = cls;
        WorkRequest build2 = ((OneTimeWorkRequest.Builder) ((OneTimeWorkRequest.Builder) new OneTimeWorkRequest.Builder(cls).setConstraints(build)).setInputData(universalRequestWorkerData.invoke())).build();
        Intrinsics.checkNotNullExpressionValue(build2, "OneTimeWorkRequestBuilde…a())\n            .build()");
        getWorkManager().enqueue((WorkRequest) (OneTimeWorkRequest) build2);
    }
}
