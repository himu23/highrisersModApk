...
public final class UniversalRequestJob$special$$inlined$inject$default$2 extends Lambda implements Function0<UniversalRequestDataSource> {
    ...
    public final UniversalRequestDataSource invoke() {
        ...
        return iServiceComponent.getServiceProvider().getRegistry().getService(this.$named, Reflection.getOrCreateKotlinClass(UniversalRequestDataSource.class));
    }
}
