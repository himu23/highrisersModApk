...
public final class ContinuationFromCallback extends WebViewCallback {
    ...
    public ContinuationFromCallback(Continuation<Object> continuation2) {
        super("", 0);
    ...
    public void invoke(Object... objArr) {
        ...
        Continuation<Object> continuation2 = this.continuation;
        Result.Companion companion = Result.Companion;
        continuation2.resumeWith(Result.m144constructorimpl(objArr));
    }
    ...
    public void error(Enum<?> enumR, Object... objArr) {
        ...
        Continuation<Object> continuation2 = this.continuation;
        Result.Companion companion = Result.Companion;
        continuation2.resumeWith(Result.m144constructorimpl(ResultKt.createFailure(new ExposureException("Invocation failed with: " + enumR, objArr))));
    }
}
