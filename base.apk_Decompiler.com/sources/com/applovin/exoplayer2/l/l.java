...
public final class l {
    public static int e(Map<String, List<String>> map) {
        List list = map.get(z3.I);
        return aU((list == null || list.isEmpty()) ? null : (String) list.get(0));
    }

    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static int aU(java.lang.String r17) {
        /*
            r0 = -1
            if (r17 != 0) goto L_0x0004
            return r0
        L_0x0004:
            java.lang.String r1 = com.applovin.exoplayer2.l.u.bb(r17)
            r1.hashCode()
            int r2 = r1.hashCode()
            r3 = 14
            r4 = 13
        ...
        L_0x0172:
            return r16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.exoplayer2.l.l.aU(java.lang.String):int");
    }
