...
public final class n {
    ...
    public static com.applovin.exoplayer2.g.a a(i iVar, boolean z) throws IOException {
        com.applovin.exoplayer2.g.a a2 = new s().a(iVar, z ? null : g.JP);
        if (a2 == null || a2.kD() == 0) {
            return null;
        }
        return a2;
    ...
    public static void c(i iVar) throws IOException {
        ...
        iVar.a(yVar.hO(), 0, 4);
        if (yVar.pv() != 1716281667) {
            throw ai.c("Failed to read FLAC stream marker.", (Throwable) null);
        }
    }
    ...
    public static p.a b(y yVar) {
        yVar.fz(1);
        int pt = yVar.pt();
        long il = ((long) yVar.il()) + ((long) pt);
        int i = pt / 18;
    ...
    public static int d(i iVar) throws IOException {
        ...
        iVar.ic();
        throw ai.c("First frame does not start with sync code.", (Throwable) null);
    }
