...
public final class ac implements g {
    ...
    public static final class a {
        ...
        public a a(byte[] bArr, int i) {
            if (this.eX == null || ai.r(Integer.valueOf(i), 3) || !ai.r(this.eY, 3)) {
    ...
    public boolean equals(Object obj) {
        ...
        ac acVar = (ac) obj;
        if (!ai.r(this.eN, acVar.eN) || !ai.r(this.eO, acVar.eO) || !ai.r(this.eP, acVar.eP) || !ai.r(this.eQ, acVar.eQ) || !ai.r(this.eR, acVar.eR) || !ai.r(this.eS, acVar.eS) || !ai.r(this.eT, acVar.eT) || !ai.r(this.eU, acVar.eU) || !ai.r(this.eV, acVar.eV) || !ai.r(this.eW, acVar.eW) || !Arrays.equals(this.eX, acVar.eX) || !ai.r(this.eY, acVar.eY) || !ai.r(this.eZ, acVar.eZ) || !ai.r(this.fa, acVar.fa) || !ai.r(this.fb, acVar.fb) || !ai.r(this.fc, acVar.fc) || !ai.r(this.fd, acVar.fd) || !ai.r(this.ff, acVar.ff) || !ai.r(this.fg, acVar.fg) || !ai.r(this.fh, acVar.fh) || !ai.r(this.fi, acVar.fi) || !ai.r(this.fj, acVar.fj) || !ai.r(this.fk, acVar.fk) || !ai.r(this.fl, acVar.fl) || !ai.r(this.fm, acVar.fm) || !ai.r(this.fn, acVar.fn) || !ai.r(this.fo, acVar.fo) || !ai.r(this.fp, acVar.fp) || !ai.r(this.fq, acVar.fq) || !ai.r(this.fr, acVar.fr)) {
            return false;
        }
        return true;
    }
