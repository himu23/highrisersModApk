...
public class BundleUtils {
    ...
    public static void put(String str, Object obj, Bundle bundle) {
        if (obj == null) {
            x.H("AppLovinSdk", "Skipped insertion into Bundle because value is null.");
            ...
            x.H("AppLovinSdk", "Skipped insertion of " + obj + " into Bundle");
        }
    }
    ...
    public static JSONObject toJSONObject(Bundle bundle) {
        ...
        try {
            ...
            x.e("AppLovinSdk", "Failed to convert Bundle to JSONObject", e);
        }
        return jSONObject;
    }
