...
public class OpenFileActivityBuilder {
    ...
    public IntentSender build(GoogleApiClient googleApiClient) {
        ...
        if (this.zzbc == null) {
            ...
            filterHolder = new FilterHolder(this.zzbc);
        }
        try {
            return ((zzeo) ((zzaw) googleApiClient.getClient(Drive.CLIENT_KEY)).getService()).zza(new zzgm(this.zzba, this.zzbb, this.zzbd, filterHolder));
