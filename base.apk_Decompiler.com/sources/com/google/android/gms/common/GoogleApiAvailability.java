...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void setDefaultNotificationChannelId(Context context, String str) {
        if (PlatformVersion.isAtLeastO()) {
            Preconditions.checkNotNull(NotificationCompat$$ExternalSyntheticApiModelOutline8.m((NotificationManager) Preconditions.checkNotNull(context.getSystemService("notification")), str));
        }
        synchronized (zaa) {
            this.zac = str;
        }
    ...
    public void showErrorNotification(Context context, int i) {
        zae(context, i, (String) null, getErrorResolutionPendingIntent(context, i, 0, z3.p));
    }
        ...
        if (i == 18) {
            ...
            if (PlatformVersion.isAtLeastO()) {
                ...
                if (str2 == null) {
                    ...
                    NotificationChannel m = NotificationCompat$$ExternalSyntheticApiModelOutline8.m(notificationManager, str2);
                    String zab2 = zac.zab(context);
                    if (m == null) {
                        notificationManager.createNotificationChannel(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(str2, (CharSequence) zab2, 4));
                    } else if (!zab2.contentEquals(ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m))) {
                        m.setName(zab2);
