...
public class KeyHandle extends AbstractSafeParcelable {
    ...
    public static KeyHandle parseFromJson(JSONObject jSONObject) throws JSONException {
        ...
        try {
            ProtocolVersion fromString = ProtocolVersion.fromString(jSONObject.has(MediationMetaData.KEY_VERSION) ? jSONObject.getString(MediationMetaData.KEY_VERSION) : null);
            try {
    ...
    public String toString() {
        List list = this.zzd;
        return String.format("{keyHandle: %s, version: %s, transports: %s}", new Object[]{Base64Utils.encode(this.zzb), this.zzc, list == null ? "null" : list.toString()});
    }
