...
final class Utf8 {
    ...
    static final class UnsafeProcessor extends Processor {
            ...
            if ((i4 | i5 | ((byteBuffer.limit() - i4) - i5)) >= 0) {
                ...
                while (j < j2) {
                    ...
                    if (DecodeUtil.isOneByte(b2)) {
                        ...
                        long j5 = j + 3;
                        j += 4;
                        DecodeUtil.handleFourBytes(b2, UnsafeUtil.getByte(j3), UnsafeUtil.getByte(2 + j), UnsafeUtil.getByte(j5), cArr, i3);
                        i3 += 2;
                    } else {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
        ...
        /* access modifiers changed from: package-private */
        /* JADX WARNING: Removed duplicated region for block: B:11:0x0044 A[LOOP:1: B:11:0x0044->B:36:0x0112, LOOP_START, PHI: r2 r4 r6 r9 r10 r12 
          PHI: (r2v2 long) = (r2v0 long), (r2v3 long) binds: [B:8:0x0039, B:36:0x0112] A[DONT_GENERATE, DONT_INLINE]
          PHI: (r4v4 long) = (r4v3 long), (r4v6 long) binds: [B:8:0x0039, B:36:0x0112] A[DONT_GENERATE, DONT_INLINE]
          PHI: (r6v3 long) = (r6v2 long), (r6v4 long) binds: [B:8:0x0039, B:36:0x0112] A[DONT_GENERATE, DONT_INLINE]
          PHI: (r9v3 int) = (r9v2 int), (r9v4 int) binds: [B:8:0x0039, B:36:0x0112] A[DONT_GENERATE, DONT_INLINE]
          PHI: (r10v1 long) = (r10v0 long), (r10v2 long) binds: [B:8:0x0039, B:36:0x0112] A[DONT_GENERATE, DONT_INLINE]
          PHI: (r12v1 char) = (r12v0 char), (r12v2 char) binds: [B:8:0x0039, B:36:0x0112] A[DONT_GENERATE, DONT_INLINE]] */
