...
public final class dc implements vb {
    ...
    @Metadata(d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u001c\u0010\u0007\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016J \u0010\f\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\nH\u0016¨\u0006\r"}, d2 = {"com/ironsource/dc$a", "Landroid/webkit/WebViewClient;", "Landroid/webkit/WebView;", "view", "", "url", "", "onPageFinished", "Landroid/webkit/WebResourceRequest;", "request", "Landroid/webkit/WebResourceError;", "error", "onReceivedError", "mediationsdk_release"}, k = 1, mv = {1, 8, 0})
    public static final class a extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
            ...
            rb.a.a(webResourceError.toString());
            yb ybVar = yb.a;
            ybVar.b("got error during TestSuite web controller loading " + webResourceError);
    ...
    public static final class b implements x6 {
        ...
        public void onUIReady() {
            if (this.a.f) {
                ...
                this.a.a.postDelayed(new dc$b$$ExternalSyntheticLambda0(this), 500);
            }
        }
    }

    public dc(TestSuiteActivity testSuiteActivity, x6 x6Var, JSONObject jSONObject, String str) {
        ...
        this.d = jSONObject;
        a(testSuiteActivity, x6Var, str);
    }

    /* access modifiers changed from: private */
    public static final void a(dc dcVar, String str) {
        Intrinsics.checkNotNullParameter(dcVar, "this$0");
        Intrinsics.checkNotNullParameter(str, "$script");
        WebView webView = dcVar.c;
        webView.loadUrl("javascript:" + str);
    }

    private final void a(TestSuiteActivity testSuiteActivity, x6 x6Var, String str) {
        ...
        this.c.addJavascriptInterface(new ub(new qb(testSuiteActivity, this.a), new b(this, x6Var), this), "TestSuiteBridge");
        ...
        this.a.postDelayed(new dc$$ExternalSyntheticLambda0(this), 2000);
        this.a.postDelayed(new dc$$ExternalSyntheticLambda1(x6Var), 5000);
    }
    ...
    /* access modifiers changed from: private */
    public static final void e(dc dcVar) {
        Intrinsics.checkNotNullParameter(dcVar, "this$0");
        dcVar.f = true;
    }
    ...
    public final void a(String str) {
        Intrinsics.checkNotNullParameter(str, "script");
        this.a.post(new dc$$ExternalSyntheticLambda2(this, str));
    }

    public void a(String str, IronSource.AD_UNIT ad_unit, List<? extends Object> list) {
