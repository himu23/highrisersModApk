...
public class NetworkSettings {
    ...
    public String getCustomNetworkAdapterName(IronSource.AD_UNIT ad_unit) {
        ...
        if ((ad_unit == null && (jSONObject = this.c) != null) || ((ad_unit.equals(IronSource.AD_UNIT.REWARDED_VIDEO) && (jSONObject = this.d) != null) || ((ad_unit.equals(IronSource.AD_UNIT.INTERSTITIAL) && (jSONObject = this.e) != null) || (ad_unit.equals(IronSource.AD_UNIT.BANNER) && (jSONObject = this.f) != null)))) {
            return jSONObject.optString(s);
        }
        if (!ad_unit.equals(IronSource.AD_UNIT.NATIVE_AD) || (jSONObject2 = this.g) == null) {
            return null;
        }
