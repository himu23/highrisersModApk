...
public class IronSourceUtils {
    ...
    public static String getDeviceType(Context context) {
        return m3.v(context) ? "Tablet" : "Phone";
    }

    public static boolean getFirstSession(Context context) {
        if (mFirstSession == null) {
            mFirstSession = Boolean.valueOf(!f7.a(context));
        }
    ...
    public static s7 getIronSourceAdvId(Context context) {
        String str;
        if (context == null) {
            return null;
        }
        String b = p.o().b(context);
    ...
    public static String getTransId(long j, String str) {
        return getSHA256(String.format("%s%s%s", new Object[]{Long.valueOf(j), p.o().p(), str}));
    }

    public static String getUserIdForNetworks() {
        String a = q4.a().a("userId");
    ...
    public static boolean isInitResponseCached(Context context) {
        return !TextUtils.isEmpty(getCachedValueByKeyOfCachedInitResponse(context, "appKey")) && !TextUtils.isEmpty(getCachedValueByKeyOfCachedInitResponse(context, c.Y1));
    }
