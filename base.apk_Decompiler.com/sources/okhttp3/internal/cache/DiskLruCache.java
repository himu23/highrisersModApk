...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            /*
                ...
                r3 = 1
                r1 = r1 ^ r3
                okhttp3.internal.cache.DiskLruCache r4 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0041 }
                boolean r4 = r4.closed     // Catch:{ all -> 0x0041 }
                r1 = r1 | r4
                if (r1 == 0) goto L_0x0013
                monitor-exit(r0)     // Catch:{ all -> 0x0041 }
                return
            L_0x0013:
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x0019 }
                r1.trimToSize()     // Catch:{ IOException -> 0x0019 }
                goto L_0x001d
            L_0x0019:
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0041 }
                r1.mostRecentTrimFailed = r3     // Catch:{ all -> 0x0041 }
            L_0x001d:
                ...
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x002f }
                r1.redundantOpCount = r2     // Catch:{ IOException -> 0x002f }
                goto L_0x003f
            L_0x002f:
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0041 }
                r1.mostRecentRebuildFailed = r3     // Catch:{ all -> 0x0041 }
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0041 }
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            java.lang.String r3 = r2.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r4 = r2.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r5 = r2.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r6 = r2.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r7 = r2.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r8 = "libcore.io.DiskLruCache"
            boolean r8 = r8.equals(r3)     // Catch:{ all -> 0x00a5 }
            if (r8 == 0) goto L_0x007c
            java.lang.String r8 = "1"
            boolean r8 = r8.equals(r4)     // Catch:{ all -> 0x00a5 }
            if (r8 == 0) goto L_0x007c
            int r8 = r9.appVersion     // Catch:{ all -> 0x00a5 }
            java.lang.String r8 = java.lang.Integer.toString(r8)     // Catch:{ all -> 0x00a5 }
            boolean r5 = r8.equals(r5)     // Catch:{ all -> 0x00a5 }
            if (r5 == 0) goto L_0x007c
            int r5 = r9.valueCount     // Catch:{ all -> 0x00a5 }
            java.lang.String r5 = java.lang.Integer.toString(r5)     // Catch:{ all -> 0x00a5 }
            boolean r5 = r5.equals(r6)     // Catch:{ all -> 0x00a5 }
            if (r5 == 0) goto L_0x007c
            java.lang.String r5 = ""
            boolean r5 = r5.equals(r7)     // Catch:{ all -> 0x00a5 }
            if (r5 == 0) goto L_0x007c
            r0 = 0
        L_0x0055:
            ...
            goto L_0x0055
        L_0x005f:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r1 = r9.lruEntries     // Catch:{ all -> 0x00a5 }
            int r1 = r1.size()     // Catch:{ all -> 0x00a5 }
            int r0 = r0 - r1
            r9.redundantOpCount = r0     // Catch:{ all -> 0x00a5 }
            boolean r0 = r2.exhausted()     // Catch:{ all -> 0x00a5 }
            if (r0 != 0) goto L_0x0072
            r9.rebuildJournal()     // Catch:{ all -> 0x00a5 }
            goto L_0x0078
        L_0x0072:
            okio.BufferedSink r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a5 }
        ...
        L_0x007c:
            ...
            r8.<init>(r1)     // Catch:{ all -> 0x00a5 }
            r8.append(r3)     // Catch:{ all -> 0x00a5 }
            r8.append(r0)     // Catch:{ all -> 0x00a5 }
            r8.append(r4)     // Catch:{ all -> 0x00a5 }
            r8.append(r0)     // Catch:{ all -> 0x00a5 }
            r8.append(r6)     // Catch:{ all -> 0x00a5 }
            r8.append(r0)     // Catch:{ all -> 0x00a5 }
            r8.append(r7)     // Catch:{ all -> 0x00a5 }
            java.lang.String r0 = "]"
            r8.append(r0)     // Catch:{ all -> 0x00a5 }
            java.lang.String r0 = r8.toString()     // Catch:{ all -> 0x00a5 }
            r5.<init>(r0)     // Catch:{ all -> 0x00a5 }
