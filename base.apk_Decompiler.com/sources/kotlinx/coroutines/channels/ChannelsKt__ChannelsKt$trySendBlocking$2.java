...
final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Result.m151isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1684successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1682closedJP2dKIU(Result.m147exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1669boximpl(obj3);
    }
}
