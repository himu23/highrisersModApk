...
public final class DelayKt {
    ...
    public static final Object m1648delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1649toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1649toDelayMillisLRDsOJo(long j) {
        if (Duration.m1475compareToLRDsOJo(j, Duration.Companion.m1578getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1494getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
