	...
	// --- Main
		...
		void main()
		{
			...
			v_TexCoordsNeg34.y -= kernel_3_4_offset * u_TextureInvSize.y;
			v_TexCoordsNeg12.y -= kernel_1_2_offset * u_TextureInvSize.y;
			v_TexCoordsPos12.y += kernel_1_2_offset * u_TextureInvSize.y;
			v_TexCoordsPos34.y += kernel_3_4_offset * u_TextureInvSize.y;
		}
